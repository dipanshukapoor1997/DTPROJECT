...
<table class="table table-condensed">
 ...
 <c:forEach items="${catList}" var="categoryObj">
  		...
  		<tr>
  			...
  			<td><a href="${contextRoot}/admin/deleteCategory/${categoryObj.categoryId}">Delete</a></td>
  			<td><a href="${contextRoot}/admin/updateCategory/${categoryObj.categoryId}">Update</a></td> 
  		</tr>
  </c:forEach>
  </tbody>
</table>
